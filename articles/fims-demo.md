...
```
    ...
    ## ℹ Total run time was 5.56011 seconds
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0
    ## ℹ Total run time was 5.45692 seconds
    ## ℹ Number of parameters: fixed_effects=48, random_effects=29, and total=77
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0
    ## ℹ Total run time was 5.96345 seconds
    ## ℹ Number of parameters: fixed_effects=48, random_effects=29, and total=77
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0 ℹ Total run time was 1.13357 minutes ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0 ℹ Total run time was 5.50899 seconds ℹ Number of
    ## parameters: fixed_effects=48, random_effects=29, and total=77 ℹ Maximum
